...
var arrowimages={down:['downarrowclass', 'arrowdown.gif', 25], right:['rightarrowclass', 'arrow-right.gif']}
...
buildmenu:function(menuid, arrowsvar){
	jQuery(document).ready(function($){
		...
		$headers.each(function(i){
			...
			$curobj.children("input:eq(0)").css(this.istopheader? {paddingRight: arrowsvar.down[2]} : {}).append(
