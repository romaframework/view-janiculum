...
<input id="${janiculum.id("content")}" class="${janiculum.cssClass(null)}" type="password" name="${janiculum.fieldName()}" value="${janiculum.content()!""}" <#if janiculum.disabled()> disabled="disabled" </#if> />
