...
<%//} 
	...
	JspTransformerHelper.addJs(JaniculumWrapper.id(component, TransformerConstants.PART_ALL), "$(\"#"+JaniculumWrapper.id(component, "content")+"\").tablesorter({ headers: { 0: { sorter: false } } });");
%>